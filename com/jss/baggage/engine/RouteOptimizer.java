...
public class RouteOptimizer {
	...
	public void optimize(Node source) {
	...
	/*
	 * This method returns the distance between the source to the selected target 
	 */
	...
	/*
	 * This method returns the path from the source to the selected target and NULL if no path exists (not reachable)
	 */
